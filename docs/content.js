                ...
                cards: [
                    {
                        ...
                        body: "The main portal for Holon HUB information, downloads, community links, and piano tooling."
                    },
                    {
                        label: "Guide",
                        title: "How To Start",
                        body: "Read the overview, check the rules, get the script path, then move into Discord for key-related access."
                    },
                    {
                        label: "Rules",
                        title: "Use It Clearly",
                        body: "Treat this page like an official info hub: updates, usage notes, and public guidance in one place."
                    },
                    {
                        label: "Tools",
                        title: "Web Utilities",
                        body: "The site also includes browser-side MIDI to JSON conversion for Holon HUB piano notes."
                    }
                ]
            },
            guide: {
                kicker: "Official Guide",
                title: "What Holon HUB is and how to use this site",
                body: "This layout is meant to feel like a proper product portal instead of a simple landing page.",
                aboutTitle: "About Holon HUB",
                aboutBody: "Holon HUB is a multi-language Roblox hub build with combat, utility, chat, piano, keyboard, decoy, and settings systems. This website is the public-facing place to explain the project, centralize links, and give users a clean starting point.",
                stepsTitle: "Quick Start",
                steps: [
                    "Read the overview and supported systems first so new users know what each part does.",
                    "Use the script and key section below as the main access area instead of scattering links around the page.",
                    "Join Discord when you need the latest announcements, key flow, or release updates."
                ],
                rulesTitle: "Rules / Notes",
                rules: [
                    "Keep the script, key flow, and announcements in one official place so users do not get confused.",
                    "Use clear wording about what is public on the site and what is handled through Discord or the in-app key system.",
                    "Show usage guidance and warnings before feature-heavy sections so the page reads like an official service portal."
                ]
            },
            tutorials: {
                ...
                items: [
                    {
                        ...
                        status: "Published",
                        url: "https://youtube.com/@holoncalm"
                    },
                    {
                        title: "How to Authenticate",
                        status: "Published",
                        url: "https://www.youtube.com/shorts/Y7afK3uZAVg"
                    },
                    {
                        title: "From Script Download to Launch",
                        status: "Published",
                        url: "https://youtube.com/shorts/9QBn_WoN2Ec?si=n8ClmvzdkXI4dhUC"
                    },
                    {
                        title: "Discord Channel / Role Guide",
                        status: "In progress",
                        url: ""
                    },
                    {
                        title: "How to Use Wings",
                        status: "Published",
                        url: "https://vt.tiktok.com/ZSu33Sfg9/"
                    },
                    {
                        title: "How to Use the Sub Tab",
                        status: "In progress",
                        url: ""
                    },
                    {
                        title: "How to Use the Settings Tab",
                        status: "In progress",
                        url: ""
                    },
                    {
                        ...
                        status: "Published",
                        url: "https://youtube.com/shorts/w7w8AlaLlQE?si=Te5ivUNj5bnnss2d"
                    },
                    {
                        title: "How to Break the House Barrier with Food",
                        status: "Published",
                        url: "https://youtube.com/shorts/Fa2FH_ReULE?si=bl5HCIqMPyh25zQP"
                    }
                ]
            },
            access: {
...
Sharing, redistributing, or publishing the key is prohibited
Do NOT give the key to other people
Do NOT post the key on videos, SNS, or GitHub

Please paste the key below into the key input field.`,
                keyCode: `holox`,
                scriptCode: `French
loadstring(game:HttpGet("https://raw.githubusercontent.com/hololove1021/HolonHUB/refs/heads/main/language/hub-fr.lua"))()

arabic
loadstring(game:HttpGet("https://raw.githubusercontent.com/hololove1021/HolonHUB/refs/heads/main/language/hub-ar.lua"))()

bengali
loadstring(game:HttpGet("https://raw.githubusercontent.com/hololove1021/HolonHUB/refs/heads/main/language/hub-bn.lua"))()

spanish
loadstring(game:HttpGet("https://raw.githubusercontent.com/hololove1021/HolonHUB/refs/heads/main/language/hub-es.lua"))()

Korean
loadstring(game:HttpGet("https://raw.githubusercontent.com/hololove1021/HolonHUB/refs/heads/main/language/hub-ko.lua"))()

Russian
loadstring(game:HttpGet("https://raw.githubusercontent.com/hololove1021/HolonHUB/refs/heads/main/language/hub-ru.lua"))()

turkish
loadstring(game:HttpGet("https://raw.githubusercontent.com/hololove1021/HolonHUB/refs/heads/main/language/hub-tr.lua"))()

Japanese
loadstring(game:HttpGet("https://raw.githubusercontent.com/hololove1021/HolonHUB/refs/heads/main/language/hub-jp.lua"))()

English
loadstring(game:HttpGet("https://raw.githubusercontent.com/hololove1021/HolonHUB/refs/heads/main/language/hub-en.lua"))()

german
loadstring(game:HttpGet("https://raw.githubusercontent.com/hololove1021/HolonHUB/refs/heads/main/language/hub-de.lua"))()`
            },
            converter: {
                kicker: "MIDI to JSON",
                ...
                cards: [
                    {
                        label: "Official",
                        title: "このサイトが何か",
                        body: "Holon HUB の案内、配布導線、コミュニティリンク、ピアノ変換ツールをまとめる公式ポータル用の見せ方です。"
                    },
                    {
                        label: "Guide",
                        title: "最初に見る場所",
                        body: "概要、ルール、スクリプト、キー案内を上から順に読めるようにして、初見でも迷いにくくします。"
                    },
                    {
                        label: "Rules",
                        title: "案内を分かりやすく",
                        body: "公開情報をサイトに集約して、更新やキー導線を Discord と役割分担できるようにします。"
                    },
                    {
                        label: "Tools",
                        title: "Web ツール",
                        body: "MIDI→JSON 変換のような補助機能もブラウザ内で使える構成にしています。"
                    }
                ]
            },
            guide: {
                kicker: "公式ガイド",
                title: "どういうサイトで、どう使うか",
                body: "ただの紹介ページではなく、Holon HUB の公式案内ページとして読める構成を想定しています。",
                aboutTitle: "Holon HUB について",
                aboutBody: "Holon HUB は、多言語対応の Roblox ハブで、戦闘系、補助系、チャット、ピアノ、キーボード、デコイ、設定保存などをまとめた構成になっています。このサイトは、その説明、導線、配布情報を見やすく集約するための入口です。",
                stepsTitle: "使い方の流れ",
                steps: [
                    "まず概要と機能一覧を見て、サイトが何を案内しているかを把握します。",
                    "次に下のスクリプト・キー案内で公式導線を確認し、必要なら Discord に進みます。",
                    "ピアノ用途なら MIDI→JSON 変換を使って、そのまま Holon HUB 向けデータを作れます。"
                ],
                rulesTitle: "ルール / 注意",
                rules: [
                    "スクリプト、キー、更新告知はできるだけ公式導線に一本化して、偽リンクと混ざらないようにします。",
                    "サイトで公開する内容と、Discord やキーシステムで扱う内容を分けて明記します。",
                    "重い機能紹介より先に、何のサイトかと使い方を見せることで、公式感と分かりやすさを優先します。"
                ]
            },
            tutorials: {
                kicker: "公式チュートリアル",
                ...
                items: [
                    ...
                    {
                        title: "Script入手から起動まで",
                        status: "公開中",
                        url: "https://youtube.com/shorts/9QBn_WoN2Ec?si=n8ClmvzdkXI4dhUC"
                    },
                    {
                        title: "Discord各チャンネル役割紹介",
                        status: "作成中",
                        url: ""
                    },
                    {
